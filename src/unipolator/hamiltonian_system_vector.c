...
/* "unipolator/hamiltonian_system_vector.pyx":11
 * 
...
static PyTypeObject *__pyx_ptype_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector = 0;
...
static const char __pyx_k_V_in_shape_0_and_V_out_shape_0_n[] = "V_in.shape[0] and V_out.shape[0] needs to be equal to H_s[0].shape[1].";
static const char __pyx_k_V_in_shape_1_and_V_out_shape_1_n[] = "V_in.shape[1] and V_out.shape[1] needs to be equal to m.";
...
static PyObject *__pyx_n_s_Hamiltonian_System_vector;
...
static PyObject *__pyx_kp_u_V_in_shape_0_and_V_out_shape_0_n;
static PyObject *__pyx_kp_u_V_in_shape_1_and_V_out_shape_1_n;
...
static PyObject *__pyx_n_s_change_tolerance;
...
static PyObject *__pyx_n_s_max_amp;
...
/* "unipolator/hamiltonian_system_vector.pyx":26
 *     cdef double mu
 * 
...
static int __pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_H_s,&__pyx_n_s_m,&__pyx_n_s_tol,&__pyx_n_s_max_amp,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  3:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_amp);
    ...
    __pyx_v_H_s = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc___pyx_t_double_complex(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_H_s.memview)) __PYX_ERR(0, 26, __pyx_L3_error)
    if (values[1]) {
      __pyx_v_m = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_m == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    } else {
      __pyx_v_m = ((int)1);
    }
    if (values[2]) {
      __pyx_v_tol = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    } else {
      __pyx_v_tol = __pyx_k_;
    }
    if (values[3]) {
      __pyx_v_max_amp = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_max_amp.memview)) __PYX_ERR(0, 26, __pyx_L3_error)
    } else {
      __pyx_v_max_amp = __pyx_k__2;
      __PYX_INC_MEMVIEW(&__pyx_v_max_amp, 1);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 0, 1, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 26, __pyx_L3_error)
  __pyx_L3_error:;
...
static int __pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector___cinit__(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, __Pyx_memviewslice __pyx_v_H_s, int __pyx_v_m, double __pyx_v_tol, __Pyx_memviewslice __pyx_v_max_amp) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":34
 * 
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":35
 *         # Construct parameters
 *         self.n_dims = H_s.shape[0]
 *         self.n_dims_1 = self.n_dims - 1             # <<<<<<<<<<<<<<
 *         self.d = H_s.shape[1]
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":36
 *         self.n_dims = H_s.shape[0]
 *         self.n_dims_1 = self.n_dims - 1
 *         self.d = H_s.shape[1]             # <<<<<<<<<<<<<<
 *         self.d2 = self.d * self.d
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":37
 *         self.n_dims_1 = self.n_dims - 1
 *         self.d = H_s.shape[1]
 *         self.d2 = self.d * self.d             # <<<<<<<<<<<<<<
 *         self.m = m
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":38
 *         self.d = H_s.shape[1]
 *         self.d2 = self.d * self.d
 *         self.m = m             # <<<<<<<<<<<<<<
 *         if max_amp[0] == -1:
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":39
 *         self.d2 = self.d * self.d
 *         self.m = m
 *         if max_amp[0] == -1:             # <<<<<<<<<<<<<<
 *             self.max_amp = np.ones(self.n_dims)
 ...
 */
  __pyx_t_1 = 0;
  __pyx_t_2 = (((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_max_amp.data) + __pyx_t_1)) ))) == -1.0) != 0);
  if (__pyx_t_2) {

    /* "unipolator/hamiltonian_system_vector.pyx":40
 *         self.m = m
 *         if max_amp[0] == -1:
 *             self.max_amp = np.ones(self.n_dims)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_ones); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_self->n_dims); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_6 = NULL;
    ...
    __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __PYX_XDEC_MEMVIEW(&__pyx_v_self->max_amp, 0);
    __pyx_v_self->max_amp = __pyx_t_7;
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":42
 *             self.max_amp = np.ones(self.n_dims)
 *         else:
 *             self.max_amp = max_amp             # <<<<<<<<<<<<<<
 * 
 ...
 */
  /*else*/ {
    __PYX_XDEC_MEMVIEW(&__pyx_v_self->max_amp, 0);
    __PYX_INC_MEMVIEW(&__pyx_v_max_amp, 0);
    __pyx_v_self->max_amp = __pyx_v_max_amp;
  }
  __pyx_L3:;

  /* "unipolator/hamiltonian_system_vector.pyx":44
 *             self.max_amp = max_amp
 * 
 *         self.H = np.empty([self.n_dims, self.d, self.d], dtype=np.complex128)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_empty); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_self->n_dims); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_self->d); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_self->d); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_8 = PyList_New(3); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 44, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_complex128); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_6, __pyx_t_8); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc___pyx_t_double_complex(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":45
 * 
 *         self.H = np.empty([self.n_dims, self.d, self.d], dtype=np.complex128)
 *         self.h0 = &self.H[0,0,0]             # <<<<<<<<<<<<<<
 *         # change elements in H to -i * H
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":47
 *         self.h0 = &self.H[0,0,0]
 *         # change elements in H to -i * H
 *         for i in range(self.n_dims):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":48
 *         # change elements in H to -i * H
 *         for i in range(self.n_dims):
 *             for j in range(self.d):             # <<<<<<<<<<<<<<
 *                 for k in range(self.d):
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":49
 *         for i in range(self.n_dims):
 *             for j in range(self.d):
 *                 for k in range(self.d):             # <<<<<<<<<<<<<<
 *                     self.H[i, j, k] = -1j * H_s[i, j, k]
 ...
 */
      ...
      for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_19; __pyx_t_20+=1) {
        ...
        /* "unipolator/hamiltonian_system_vector.pyx":50
 *             for j in range(self.d):
 *                 for k in range(self.d):
 *                     self.H[i, j, k] = -1j * H_s[i, j, k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":52
 *                     self.H[i, j, k] = -1j * H_s[i, j, k]
 * 
 *         self.V = np.empty([self.d, self.d], dtype=np.complex128)             # <<<<<<<<<<<<<<
 *         self.v0 = &self.V[0, 0]
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_empty); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_self->d); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_self->d); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_complex128); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_4) < 0) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_6, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_24 = __Pyx_PyObject_to_MemoryviewSlice_d_dc___pyx_t_double_complex(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_24.memview)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":53
 * 
 *         self.V = np.empty([self.d, self.d], dtype=np.complex128)
 *         self.v0 = &self.V[0, 0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":55
 *         self.v0 = &self.V[0, 0]
 * 
 *         self.curr_h0 = &self.H[0, 0, 0]             # <<<<<<<<<<<<<<
 *         self.change_m(m)
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":56
 * 
 *         self.curr_h0 = &self.H[0, 0, 0]
 *         self.change_m(m)             # <<<<<<<<<<<<<<
 *         self.change_tolerance(tol)
 * 
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_change_m); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_m); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_8 = NULL;
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":57
 *         self.curr_h0 = &self.H[0, 0, 0]
 *         self.change_m(m)
 *         self.change_tolerance(tol)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_change_tolerance); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_max_amp, 1);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "unipolator/hamiltonian_system_vector.pyx":60
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_3change_m(PyObject *__pyx_v_self, PyObject *__pyx_arg_m); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_2change_m[] = "Hamiltonian_System_vector.change_m(self, int m)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_3change_m(PyObject *__pyx_v_self, PyObject *__pyx_arg_m) {
  int __pyx_v_m;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  assert(__pyx_arg_m); {
    __pyx_v_m = __Pyx_PyInt_As_int(__pyx_arg_m); if (unlikely((__pyx_v_m == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_2change_m(((struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *)__pyx_v_self), ((int)__pyx_v_m));
...
static PyObject *__pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_2change_m(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, int __pyx_v_m) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":61
 * 
 *     def change_m(self, int m):
 *         self.m = m             # <<<<<<<<<<<<<<
 *         self.dm = self.d * m
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":62
 *     def change_m(self, int m):
 *         self.m = m
 *         self.dm = self.d * m             # <<<<<<<<<<<<<<
 *         self.V_in = np.empty([self.d, self.dm], dtype=np.complex128)
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":63
 *         self.m = m
 *         self.dm = self.d * m
 *         self.V_in = np.empty([self.d, self.dm], dtype=np.complex128)             # <<<<<<<<<<<<<<
 *         self.v_in = &self.V_in[0, 0]
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __PYX_XDEC_MEMVIEW(&__pyx_v_self->V_in, 0);
  __pyx_v_self->V_in = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "unipolator/hamiltonian_system_vector.pyx":64
 *         self.dm = self.d * m
 *         self.V_in = np.empty([self.d, self.dm], dtype=np.complex128)
 *         self.v_in = &self.V_in[0, 0]             # <<<<<<<<<<<<<<
 *         self.V_inter = np.empty([self.d, self.dm], dtype=np.complex128)
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":65
 *         self.V_in = np.empty([self.d, self.dm], dtype=np.complex128)
 *         self.v_in = &self.V_in[0, 0]
 *         self.V_inter = np.empty([self.d, self.dm], dtype=np.complex128)             # <<<<<<<<<<<<<<
 *         self.v_inter = &self.V_inter[0, 0]
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __PYX_XDEC_MEMVIEW(&__pyx_v_self->V_inter, 0);
  __pyx_v_self->V_inter = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "unipolator/hamiltonian_system_vector.pyx":66
 *         self.v_in = &self.V_in[0, 0]
 *         self.V_inter = np.empty([self.d, self.dm], dtype=np.complex128)
 *         self.v_inter = &self.V_inter[0, 0]             # <<<<<<<<<<<<<<
 * 
...
/* "unipolator/hamiltonian_system_vector.pyx":68
 *         self.v_inter = &self.V_inter[0, 0]
 * 
 *     def change_tolerance(self, double tol):             # <<<<<<<<<<<<<<
 *         self.tol = tol
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_5change_tolerance(PyObject *__pyx_v_self, PyObject *__pyx_arg_tol); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_4change_tolerance[] = "Hamiltonian_System_vector.change_tolerance(self, double tol)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_5change_tolerance(PyObject *__pyx_v_self, PyObject *__pyx_arg_tol) {
  double __pyx_v_tol;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  assert(__pyx_arg_tol); {
    __pyx_v_tol = __pyx_PyFloat_AsDouble(__pyx_arg_tol); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_4change_tolerance(((struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *)__pyx_v_self), ((double)__pyx_v_tol));
...
static PyObject *__pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_4change_tolerance(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, double __pyx_v_tol) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":69
 * 
 *     def change_tolerance(self, double tol):
 *         self.tol = tol             # <<<<<<<<<<<<<<
 *         self.weighted_hamiltonian(self.max_amp)
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":70
 *     def change_tolerance(self, double tol):
 *         self.tol = tol
 *         self.weighted_hamiltonian(self.max_amp)             # <<<<<<<<<<<<<<
 *         self.m_star, self.s, self.mu = expm_multiply_prepare(self.V, self.m, self.tol)
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":71
 *         self.tol = tol
 *         self.weighted_hamiltonian(self.max_amp)
 *         self.m_star, self.s, self.mu = expm_multiply_prepare(self.V, self.m, self.tol)             # <<<<<<<<<<<<<<
 * 
...
/* "unipolator/hamiltonian_system_vector.pyx":73
 *         self.m_star, self.s, self.mu = expm_multiply_prepare(self.V, self.m, self.tol)
 * 
 *     def get_parameters(self):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_7get_parameters(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_6get_parameters[] = "Hamiltonian_System_vector.get_parameters(self)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_7get_parameters(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
...
static PyObject *__pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_6get_parameters(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":74
 * 
 *     def get_parameters(self):
 *         return self.m_star, self.s, self.mu             # <<<<<<<<<<<<<<
 * 
...
/* "unipolator/hamiltonian_system_vector.pyx":76
 *         return self.m_star, self.s, self.mu
 * 
 *     def set_m_star(self, int m_star):             # <<<<<<<<<<<<<<
 *         self.m_star = m_star
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_9set_m_star(PyObject *__pyx_v_self, PyObject *__pyx_arg_m_star); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_8set_m_star[] = "Hamiltonian_System_vector.set_m_star(self, int m_star)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_9set_m_star(PyObject *__pyx_v_self, PyObject *__pyx_arg_m_star) {
  int __pyx_v_m_star;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  assert(__pyx_arg_m_star); {
    __pyx_v_m_star = __Pyx_PyInt_As_int(__pyx_arg_m_star); if (unlikely((__pyx_v_m_star == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 76, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_8set_m_star(((struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *)__pyx_v_self), ((int)__pyx_v_m_star));
...
static PyObject *__pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_8set_m_star(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, int __pyx_v_m_star) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":77
 * 
 *     def set_m_star(self, int m_star):
 *         self.m_star = m_star             # <<<<<<<<<<<<<<
 * 
...
/* "unipolator/hamiltonian_system_vector.pyx":79
 *         self.m_star = m_star
 * 
 *     def set_s(self, int s):             # <<<<<<<<<<<<<<
 *         self.s = s
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_11set_s(PyObject *__pyx_v_self, PyObject *__pyx_arg_s); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_10set_s[] = "Hamiltonian_System_vector.set_s(self, int s)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_11set_s(PyObject *__pyx_v_self, PyObject *__pyx_arg_s) {
  int __pyx_v_s;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  assert(__pyx_arg_s); {
    __pyx_v_s = __Pyx_PyInt_As_int(__pyx_arg_s); if (unlikely((__pyx_v_s == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 79, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_10set_s(((struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *)__pyx_v_self), ((int)__pyx_v_s));
...
static PyObject *__pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_10set_s(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, int __pyx_v_s) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":80
 * 
 *     def set_s(self, int s):
 *         self.s = s             # <<<<<<<<<<<<<<
 * 
...
/* "unipolator/hamiltonian_system_vector.pyx":82
 *         self.s = s
 * 
 *     def set_mu(self, double mu):             # <<<<<<<<<<<<<<
 *         self.mu = mu
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_13set_mu(PyObject *__pyx_v_self, PyObject *__pyx_arg_mu); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_12set_mu[] = "Hamiltonian_System_vector.set_mu(self, double mu)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_13set_mu(PyObject *__pyx_v_self, PyObject *__pyx_arg_mu) {
  double __pyx_v_mu;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  assert(__pyx_arg_mu); {
    __pyx_v_mu = __pyx_PyFloat_AsDouble(__pyx_arg_mu); if (unlikely((__pyx_v_mu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 82, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_12set_mu(((struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *)__pyx_v_self), ((double)__pyx_v_mu));
...
static PyObject *__pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_12set_mu(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, double __pyx_v_mu) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":83
 * 
 *     def set_mu(self, double mu):
 *         self.mu = mu             # <<<<<<<<<<<<<<
 * 
...
/* "unipolator/hamiltonian_system_vector.pyx":86
 * 
 * 
...
static PyObject *__pyx_f_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_weighted_hamiltonian(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, __Pyx_memviewslice __pyx_v_c) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":87
 * 
 *     cdef weighted_hamiltonian(self, double[::1] c):
 *         self.curr_h0 = self.h0             # <<<<<<<<<<<<<<
 *         copy_pointer(self.curr_h0, self.v0, self.d2)
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":88
 *     cdef weighted_hamiltonian(self, double[::1] c):
 *         self.curr_h0 = self.h0
 *         copy_pointer(self.curr_h0, self.v0, self.d2)             # <<<<<<<<<<<<<<
 *         for i in range(self.n_dims_1):
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":89
 *         self.curr_h0 = self.h0
 *         copy_pointer(self.curr_h0, self.v0, self.d2)
 *         for i in range(self.n_dims_1):             # <<<<<<<<<<<<<<
 *             self.curr_h0 += self.d2
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":90
 *         copy_pointer(self.curr_h0, self.v0, self.d2)
 *         for i in range(self.n_dims_1):
 *             self.curr_h0 += self.d2             # <<<<<<<<<<<<<<
 *             d_mat_add_pointer(self.v0, self.curr_h0, c[i], self.d2)
 ...
 */
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":91
 *         for i in range(self.n_dims_1):
 *             self.curr_h0 += self.d2
 *             d_mat_add_pointer(self.v0, self.curr_h0, c[i], self.d2)             # <<<<<<<<<<<<<<
 * 
...
/* "unipolator/hamiltonian_system_vector.pyx":94
 * 
 * 
...
static void __pyx_f_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_expm_multiply_cython(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, __Pyx_memviewslice __pyx_v_V_out) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":99
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":101
 *         cdef double complex *vout = &V_out[0, 0] # V_out
 *         cdef int temp_int, i, j
 *         cdef int incz = 1             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":103
 *         cdef int incz = 1
 *         cdef double factor, c1, c2, max_amp
 *         cdef double complex coeff = 1.0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":104
 *         cdef double factor, c1, c2, max_amp
 *         cdef double complex coeff = 1.0
 *         cdef double complex eta = exp(self.mu / float(self.s))  # Compute scaling factor eta             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":106
 *         cdef double complex eta = exp(self.mu / float(self.s))  # Compute scaling factor eta
 * 
 *         copy_pointer(self.v_in, vout, self.dm)  # Initialize F as B             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":108
 *         copy_pointer(self.v_in, vout, self.dm)  # Initialize F as B
 *         # Perform s iterations
 *         for i in range(self.s):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":109
 *         # Perform s iterations
 *         for i in range(self.s):
 *             c1 = norm_inf_complex(self.V_in, self.d, self.m)            # Compute infinity norm of V_in             # <<<<<<<<<<<<<<
 *             for j in range(self.m_star):
 ...
 */
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":110
 *         for i in range(self.s):
 *             c1 = norm_inf_complex(self.V_in, self.d, self.m)            # Compute infinity norm of V_in
 *             for j in range(self.m_star):             # <<<<<<<<<<<<<<
 *                 temp_int = self.s*(j+1)
 ...
 */
    ...
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":111
 *             c1 = norm_inf_complex(self.V_in, self.d, self.m)            # Compute infinity norm of V_in
 *             for j in range(self.m_star):
 *                 temp_int = self.s*(j+1)             # <<<<<<<<<<<<<<
 *                 factor = <double> float(temp_int)
 ...
 */
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":112
 *             for j in range(self.m_star):
 *                 temp_int = self.s*(j+1)
 *                 factor = <double> float(temp_int)             # <<<<<<<<<<<<<<
 *                 coeff = 1 / factor   #.real
 ...
 */
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":113
 *                 temp_int = self.s*(j+1)
 *                 factor = <double> float(temp_int)
 *                 coeff = 1 / factor   #.real             # <<<<<<<<<<<<<<
 *                 # preform matrix multiplication G = A @ B
 ...
 */
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":115
 *                 coeff = 1 / factor   #.real
 *                 # preform matrix multiplication G = A @ B
 *                 MM_cdot_pointer_v_scaled(self.v0, self.v_in, self.v_inter, coeff, self.d, self.m)  # Update B ( B = coeff * A.dot(B) ) -> switch every iteration between B and G             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":117
 *                 MM_cdot_pointer_v_scaled(self.v0, self.v_in, self.v_inter, coeff, self.d, self.m)  # Update B ( B = coeff * A.dot(B) ) -> switch every iteration between B and G
 *                 # switch pointers of B and G    #Old Approach: C = B; B = G; G = C
 *                 copy_pointer(self.v_inter, self.v_in, self.dm)             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":118
 *                 # switch pointers of B and G    #Old Approach: C = B; B = G; G = C
 *                 copy_pointer(self.v_inter, self.v_in, self.dm)
 *                 c2 = norm_inf_complex(self.V_in, self.d, self.m)        # Compute norm of updated B             # <<<<<<<<<<<<<<
 *                 c_mat_add_pointer(vout, self.v_in, self.dm)   # Update F ( F= F + B )
 ...
 */
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":119
 *                 copy_pointer(self.v_inter, self.v_in, self.dm)
 *                 c2 = norm_inf_complex(self.V_in, self.d, self.m)        # Compute norm of updated B
 *                 c_mat_add_pointer(vout, self.v_in, self.dm)   # Update F ( F= F + B )             # <<<<<<<<<<<<<<
 *                 max_amp = norm_inf_complex(V_out, self.d, self.m)
 ...
 */
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":120
 *                 c2 = norm_inf_complex(self.V_in, self.d, self.m)        # Compute norm of updated B
 *                 c_mat_add_pointer(vout, self.v_in, self.dm)   # Update F ( F= F + B )
 *                 max_amp = norm_inf_complex(V_out, self.d, self.m)             # <<<<<<<<<<<<<<
 *                 if c1 + c2 <= self.tol * max_amp:  # Check if tolerance is reached
 ...
 */
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":121
 *                 c_mat_add_pointer(vout, self.v_in, self.dm)   # Update F ( F= F + B )
 *                 max_amp = norm_inf_complex(V_out, self.d, self.m)
 *                 if c1 + c2 <= self.tol * max_amp:  # Check if tolerance is reached             # <<<<<<<<<<<<<<
 *                     break
 *                 c1 = c2
 */
      __pyx_t_9 = (((__pyx_v_c1 + __pyx_v_c2) <= (__pyx_v_self->tol * __pyx_v_max_amp)) != 0);
      if (__pyx_t_9) {

        /* "unipolator/hamiltonian_system_vector.pyx":122
 *                 max_amp = norm_inf_complex(V_out, self.d, self.m)
 *                 if c1 + c2 <= self.tol * max_amp:  # Check if tolerance is reached
 *                     break             # <<<<<<<<<<<<<<
 *                 c1 = c2
 ...
 */
      ...
      /* "unipolator/hamiltonian_system_vector.pyx":123
 *                 if c1 + c2 <= self.tol * max_amp:  # Check if tolerance is reached
 *                     break
 *                 c1 = c2             # <<<<<<<<<<<<<<
 *             zscal(&self.dm, &eta, vout, &incz)  # Scale v_out by eta
 ...
 */
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":124
 *                     break
 *                 c1 = c2
 *             zscal(&self.dm, &eta, vout, &incz)  # Scale v_out by eta             # <<<<<<<<<<<<<<
 *             copy_pointer(vout, self.v_in, self.dm)  # Copy v_out to v_in
 ...
 */
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":125
 *                 c1 = c2
 *             zscal(&self.dm, &eta, vout, &incz)  # Scale v_out by eta
 *             copy_pointer(vout, self.v_in, self.dm)  # Copy v_out to v_in             # <<<<<<<<<<<<<<
 * 
...
/* "unipolator/hamiltonian_system_vector.pyx":128
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_15expmH(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_14expmH[] = "Hamiltonian_System_vector.expmH(self, double[::1] c, double complex[:, ::1] V_in, double complex[:, ::1] V_out)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_15expmH(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_c,&__pyx_n_s_V_in,&__pyx_n_s_V_out,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_V_in)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("expmH", 1, 3, 3, 1); __PYX_ERR(0, 128, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_V_out)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("expmH", 1, 3, 3, 2); __PYX_ERR(0, 128, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "expmH") < 0)) __PYX_ERR(0, 128, __pyx_L3_error)
      }
    ...
    __pyx_v_c = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_c.memview)) __PYX_ERR(0, 128, __pyx_L3_error)
    __pyx_v_V_in = __Pyx_PyObject_to_MemoryviewSlice_d_dc___pyx_t_double_complex(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_V_in.memview)) __PYX_ERR(0, 128, __pyx_L3_error)
    __pyx_v_V_out = __Pyx_PyObject_to_MemoryviewSlice_d_dc___pyx_t_double_complex(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_V_out.memview)) __PYX_ERR(0, 128, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("expmH", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 128, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_14expmH(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, __Pyx_memviewslice __pyx_v_c, __Pyx_memviewslice __pyx_v_V_in, __Pyx_memviewslice __pyx_v_V_out) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":130
 *     def expmH(self, double[::1] c, double complex[:,::1] V_in, double complex[:,::1] V_out):
 *         # Construct Hamiltonian
 *         if not c.shape[0] == self.n_dims_1:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":131
 *         # Construct Hamiltonian
 *         if not c.shape[0] == self.n_dims_1:
 *             raise ValueError('c.shape[0] needs to be equal to H_s[0].shape[0]-1.')             # <<<<<<<<<<<<<<
 *         if not V_in.shape[0] == V_out.shape[0] == self.d:
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 131, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":132
 *         if not c.shape[0] == self.n_dims_1:
 *             raise ValueError('c.shape[0] needs to be equal to H_s[0].shape[0]-1.')
 *         if not V_in.shape[0] == V_out.shape[0] == self.d:             # <<<<<<<<<<<<<<
 *             raise ValueError('V_in.shape[0] and V_out.shape[0] needs to be equal to H_s[0].shape[1].')
 ...
 */
  ...
  if (unlikely(__pyx_t_3)) {
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":133
 *             raise ValueError('c.shape[0] needs to be equal to H_s[0].shape[0]-1.')
 *         if not V_in.shape[0] == V_out.shape[0] == self.d:
 *             raise ValueError('V_in.shape[0] and V_out.shape[0] needs to be equal to H_s[0].shape[1].')             # <<<<<<<<<<<<<<
 *         if not V_in.shape[1] == V_out.shape[1] == self.m:
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":134
 *         if not V_in.shape[0] == V_out.shape[0] == self.d:
 *             raise ValueError('V_in.shape[0] and V_out.shape[0] needs to be equal to H_s[0].shape[1].')
 *         if not V_in.shape[1] == V_out.shape[1] == self.m:             # <<<<<<<<<<<<<<
 *             raise ValueError('V_in.shape[1] and V_out.shape[1] needs to be equal to m.')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":135
 *             raise ValueError('V_in.shape[0] and V_out.shape[0] needs to be equal to H_s[0].shape[1].')
 *         if not V_in.shape[1] == V_out.shape[1] == self.m:
 *             raise ValueError('V_in.shape[1] and V_out.shape[1] needs to be equal to m.')             # <<<<<<<<<<<<<<
 *         cdef double complex *vin = &V_in[0, 0] # V_in
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":136
 *         if not V_in.shape[1] == V_out.shape[1] == self.m:
 *             raise ValueError('V_in.shape[1] and V_out.shape[1] needs to be equal to m.')
 *         cdef double complex *vin = &V_in[0, 0] # V_in             # <<<<<<<<<<<<<<
 *         copy_pointer(vin, self.v_in, self.dm)
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":137
 *             raise ValueError('V_in.shape[1] and V_out.shape[1] needs to be equal to m.')
 *         cdef double complex *vin = &V_in[0, 0] # V_in
 *         copy_pointer(vin, self.v_in, self.dm)             # <<<<<<<<<<<<<<
 *         self.weighted_hamiltonian(c)
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":138
 *         cdef double complex *vin = &V_in[0, 0] # V_in
 *         copy_pointer(vin, self.v_in, self.dm)
 *         self.weighted_hamiltonian(c)             # <<<<<<<<<<<<<<
 *         self.expm_multiply_cython(V_out)
 * 
 */
  __pyx_t_2 = ((struct __pyx_vtabstruct_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *)__pyx_v_self->__pyx_vtab)->weighted_hamiltonian(__pyx_v_self, __pyx_v_c); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 138, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "unipolator/hamiltonian_system_vector.pyx":139
 *         copy_pointer(vin, self.v_in, self.dm)
 *         self.weighted_hamiltonian(c)
 *         self.expm_multiply_cython(V_out)             # <<<<<<<<<<<<<<
 * 
...
/* "unipolator/hamiltonian_system_vector.pyx":141
 *         self.expm_multiply_cython(V_out)
 * 
 *     def expmH_pulse_no_multiply(self, double[:,::1] cs, double complex[:,::1] V_in, double complex[:,:,::1] V_out):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_17expmH_pulse_no_multiply(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_16expmH_pulse_no_multiply[] = "Hamiltonian_System_vector.expmH_pulse_no_multiply(self, double[:, ::1] cs, double complex[:, ::1] V_in, double complex[:, :, ::1] V_out)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_17expmH_pulse_no_multiply(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_cs,&__pyx_n_s_V_in,&__pyx_n_s_V_out,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_V_in)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("expmH_pulse_no_multiply", 1, 3, 3, 1); __PYX_ERR(0, 141, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_V_out)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("expmH_pulse_no_multiply", 1, 3, 3, 2); __PYX_ERR(0, 141, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "expmH_pulse_no_multiply") < 0)) __PYX_ERR(0, 141, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_cs = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_cs.memview)) __PYX_ERR(0, 141, __pyx_L3_error)
    __pyx_v_V_in = __Pyx_PyObject_to_MemoryviewSlice_d_dc___pyx_t_double_complex(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_V_in.memview)) __PYX_ERR(0, 141, __pyx_L3_error)
    __pyx_v_V_out = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc___pyx_t_double_complex(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_V_out.memview)) __PYX_ERR(0, 141, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("expmH_pulse_no_multiply", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 141, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_16expmH_pulse_no_multiply(struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *__pyx_v_self, __Pyx_memviewslice __pyx_v_cs, __Pyx_memviewslice __pyx_v_V_in, __Pyx_memviewslice __pyx_v_V_out) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":143
 *     def expmH_pulse_no_multiply(self, double[:,::1] cs, double complex[:,::1] V_in, double complex[:,:,::1] V_out):
 *         # repeatedly calculate expmH for different c and store them in different V_out
 *         cdef int n = cs.shape[0]             # <<<<<<<<<<<<<<
 *         cdef double complex *vin = &V_in[0, 0] # V_in
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":144
 *         # repeatedly calculate expmH for different c and store them in different V_out
 *         cdef int n = cs.shape[0]
 *         cdef double complex *vin = &V_in[0, 0] # V_in             # <<<<<<<<<<<<<<
 *         copy_pointer(vin, self.v_in, self.dm)
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":145
 *         cdef int n = cs.shape[0]
 *         cdef double complex *vin = &V_in[0, 0] # V_in
 *         copy_pointer(vin, self.v_in, self.dm)             # <<<<<<<<<<<<<<
 *         for i in range(n):
 ...
 */
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":146
 *         cdef double complex *vin = &V_in[0, 0] # V_in
 *         copy_pointer(vin, self.v_in, self.dm)
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             self.weighted_hamiltonian(cs[i,:])
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":147
 *         copy_pointer(vin, self.v_in, self.dm)
 *         for i in range(n):
 *             self.weighted_hamiltonian(cs[i,:])             # <<<<<<<<<<<<<<
 *             self.expm_multiply_cython(V_out[i,:,:])
...
__pyx_t_7 = ((struct __pyx_vtabstruct_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *)__pyx_v_self->__pyx_vtab)->weighted_hamiltonian(__pyx_v_self, __pyx_t_6); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 147, __pyx_L1_error)
    ...
    /* "unipolator/hamiltonian_system_vector.pyx":148
 *         for i in range(n):
 *             self.weighted_hamiltonian(cs[i,:])
 *             self.expm_multiply_cython(V_out[i,:,:])             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_19__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_18__reduce_cython__[] = "Hamiltonian_System_vector.__reduce_cython__(self)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_19__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_21__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static char __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_20__setstate_cython__[] = "Hamiltonian_System_vector.__setstate_cython__(self, __pyx_state)";
static PyObject *__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_21__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_20__setstate_cython__(((struct __pyx_obj_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static void __pyx_tp_dealloc_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector(PyObject *o) {
  ...
  __PYX_XDEC_MEMVIEW(&p->V, 1);
  __PYX_XDEC_MEMVIEW(&p->V_inter, 1);
  __PYX_XDEC_MEMVIEW(&p->V_in, 1);
  __PYX_XDEC_MEMVIEW(&p->max_amp, 1);
  (*Py_TYPE(o)->tp_free)(o);
}

static PyMethodDef __pyx_methods_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector[] = {
  {"change_m", (PyCFunction)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_3change_m, METH_O, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_2change_m},
  {"change_tolerance", (PyCFunction)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_5change_tolerance, METH_O, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_4change_tolerance},
  {"get_parameters", (PyCFunction)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_7get_parameters, METH_NOARGS, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_6get_parameters},
  {"set_m_star", (PyCFunction)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_9set_m_star, METH_O, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_8set_m_star},
  {"set_s", (PyCFunction)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_11set_s, METH_O, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_10set_s},
  {"set_mu", (PyCFunction)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_13set_mu, METH_O, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_12set_mu},
  {"expmH", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_15expmH, METH_VARARGS|METH_KEYWORDS, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_14expmH},
  {"expmH_pulse_no_multiply", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_17expmH_pulse_no_multiply, METH_VARARGS|METH_KEYWORDS, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_16expmH_pulse_no_multiply},
  {"__reduce_cython__", (PyCFunction)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_19__reduce_cython__, METH_NOARGS, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_18__reduce_cython__},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_21__setstate_cython__, METH_O, __pyx_doc_10unipolator_25hamiltonian_system_vector_25Hamiltonian_System_vector_20__setstate_cython__},
  {0, 0, 0, 0}
};
 ...
 *             raise ValueError('V_in.shape[0] and V_out.shape[0] needs to be equal to H_s[0].shape[1].')
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_u_c_shape_0_needs_to_be_equal_to_H); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 131, __pyx_L1_error)
 ...
 *             raise ValueError('V_in.shape[1] and V_out.shape[1] needs to be equal to m.')
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_kp_u_V_in_shape_0_and_V_out_shape_0_n); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 133, __pyx_L1_error)
 ...
 *         copy_pointer(vin, self.v_in, self.dm)
 */
  __pyx_tuple__5 = PyTuple_Pack(1, __pyx_kp_u_V_in_shape_1_and_V_out_shape_1_n); if (unlikely(!__pyx_tuple__5)) __PYX_ERR(0, 135, __pyx_L1_error)
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  if (PyType_Ready(&__pyx_type_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector.tp_print = 0;
  #endif
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector.tp_dictoffset && __pyx_type_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector.tp_getattro = __Pyx_PyObject_GenericGetAttr;
  }
  if (__Pyx_SetVtable(__pyx_type_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector.tp_dict, __pyx_vtabptr_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_Hamiltonian_System_vector, (PyObject *)&__pyx_type_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_10unipolator_25hamiltonian_system_vector_Hamiltonian_System_vector) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  if (__Pyx_ImportFunction_0_29_35(__pyx_t_1, "c_mat_add_pointer", (void (**)(void))&__pyx_f_10unipolator_14blas_functions_c_mat_add_pointer, "void (__pyx_t_double_complex *, __pyx_t_double_complex *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("unipolator.blas_functions_vectors"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction_0_29_35(__pyx_t_1, "MM_cdot_pointer_v_scaled", (void (**)(void))&__pyx_f_10unipolator_22blas_functions_vectors_MM_cdot_pointer_v_scaled, "void (__pyx_t_double_complex *, __pyx_t_double_complex *, __pyx_t_double_complex *, __pyx_t_double_complex, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_0_29_35(__pyx_t_1, "norm_inf_complex", (void (**)(void))&__pyx_f_10unipolator_22blas_functions_vectors_norm_inf_complex, "double (__Pyx_memviewslice, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_0_29_35(__pyx_t_1, "expm_multiply_prepare", (void (**)(void))&__pyx_f_10unipolator_22blas_functions_vectors_expm_multiply_prepare, "PyObject *(__Pyx_memviewslice, int, double, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
if (!__Pyx_RefNanny) {
  ...
  /* "unipolator/hamiltonian_system_vector.pyx":2
 ...
 *         # H_s is a 3D array of shape (n_dims, d, d) where n_dims is the number of dimensions of the Hamiltonian and d is the dimension of the Hilbert space
 */
  __pyx_k_ = __Pyx_pow_long(2, -53L);
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_array); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_k__2 = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "unipolator/hamiltonian_system_vector.pyx":1
 * #cython: language_level=3             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as npc
 */
 ...
 * 
 */
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__30, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 288, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 * 
 */
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__31, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 289, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 * 
 */
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__32, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 292, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 * 
 */
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__33, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 293, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
