...
hilbert_dim = {'label':'Hilbert space dimension', 'name': 'dim_hilbert', 'def_val': 16, 'variation_vals': 2**np.arange(1, 11), 'variation_type': 'log_int'}
...
redo = False
to_do = ['times']   
combinations = ['dim_hilbert num_contrls']
