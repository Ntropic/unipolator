...
# Methods to use 
m_times_list_ui = [0,1,2,3,4,5,6,7,8] 
...
for i, combination in enumerate(combinations):
    ...
    k = JIT_kronbinations(parameters, func=Binned_Infidelities_and_Times, other_func=other_func, import_statements=import_statements, other_arguments=[method_dict, to_do], redo=redo)
